...
const AgentDirectory: React.FC = () => {
  const { startSession, setPendingGuide, visited } = useStore();
      ...
      <div className="mt-16 pt-12 border-t border-gray-700/50 text-center">
         ...
         <div className="flex justify-center">
            <div
              ...
              >
                <guide.icon className={`w-24 h-24 mb-4 ${guide.themeColor}`} strokeWidth={1}/>
                <h3 className="font-bold text-2xl text-gray-100">{guide.name}</h3>
